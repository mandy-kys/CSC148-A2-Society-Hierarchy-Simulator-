...
def test_get_district_name() -> None:
    ...
    assert result == 'D2'
    s1 = promote_citizen_example()
    target = s1.get_citizen(6)
    result1 = target.get_district_name()
    assert result1 == 'Area 52'
